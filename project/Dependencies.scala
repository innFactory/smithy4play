...
object Dependencies {
  ...
  val alloyCore          = "com.disneystreaming.alloy"     % "alloy-core"                % "0.3.2"
  val alloyOpenapi       = "com.disneystreaming.alloy"    %% "alloy-openapi"             % "0.3.2"

  val classgraph    = "io.github.classgraph" % "classgraph" % "4.8.167"
