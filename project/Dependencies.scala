...
object Dependencies {
  ...
  val alloyCore          = "com.disneystreaming.alloy"     % "alloy-core"                % "0.3.37"
  val alloyOpenapi       = "com.disneystreaming.alloy"    %% "alloy-openapi"             % "0.3.37"
  ...
  val opentelemetryAPI      = "io.opentelemetry" % "opentelemetry-api"       % "1.60.1"
